...
public class CheckDistanceCondition : Condition
{
    ...
    public CheckDistanceCondition (Transform from, Transform to, float distanceToCheck, COMPARISON comparison) {
        this.from = from;
        this.to = to;
    ...
    private bool InternalDistanceCompare () {
        ...
        switch(comparison) {
            case COMPARISON.EQUAL:
                return Mathf.Approximately(distanceSquared, distanceToCheck);
